...
test('callBind', function (t) {
  ...
  t.equal(bound.length, func.length, 'function length is preserved', {
  ...
  t.equal(boundR.length, func.length - 1, 'function length is preserved', {
    skip: !functionsHaveConfigurableLengths
  });
  ...
  t.equal(boundArg.length, func.length - 2, 'function length is preserved', {
    skip: !functionsHaveConfigurableLengths
  });
