...
function (_ExpressionScope) {
  ...
  function ArrowHeadParsingScope(type) {
    ...
    _this40 = _possibleConstructorReturn(this, _getPrototypeOf(ArrowHeadParsingScope).call(this, type));
...
function (_StatementParser) {
  ...
  function Parser(options, input) {
    ...
    _this55 = _possibleConstructorReturn(this, _getPrototypeOf(Parser).call(this, options, input));
